...
namespace UnitTestForLoopEnhance
{
    public class TestZoneCommandReserve
    {
        ...
        private void setVehicleData(StubObjectCollection stub)
        {
            ...
            setDefaultVhStatus(vh1);
            setDefaultVhStatus(vh2);
            setDefaultVhStatus(vh3);
        ...
        private void setDefaultVhStatus(AVEHICLE vh)
        {
            vh.isTcpIpConnect = true;
            vh.IS_INSTALLED = true;
            vh.MODE_STATUS =  com.mirle.ibg3k0.sc.ProtocolFormat.OHTMessage.VHModeStatus.AutoRemote;
            vh.IsError = false;
            vh.CUR_ADR_ID = "12027";
        ...
        public void 車子上報ZoneCommandRequest_該Zone命令1筆_有空車在距離外_回復有命令()
        {
            ...
            stub.vehicleBLL.loadCyclingAndTransferReadyVhs(stub.cmdBLL).
                Where(v => v.VEHICLE_ID == "B7_OHBLINE3_CR2").FirstOrDefault().CUR_SEC_ID = "30140";
        ...
        {
            //Arrange B7_OHBlOOP_T09-x:15025 y:2270
            var cmd_mcs1 = bulidFackCMD_MCS("1", "B7_OHBlOOP_T09", "B7_OHBLINE3-ZONE2");
