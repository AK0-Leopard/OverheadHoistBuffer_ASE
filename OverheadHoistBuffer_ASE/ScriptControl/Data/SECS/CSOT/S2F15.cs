...
namespace com.mirle.ibg3k0.sc.Data.SECS.CSOT
{
    ...
    public class S2F15 : SXFY
    {
        ...
        public class ECVITEM : SXFY
        {
            ...
            [SecsElement(Index = 1, Type = SecsElement.SecsElementType.TYPE_2_BYTE_UNSIGNED_INTEGER, Length = 4)]//變更Type為TYPE_2_BYTE_UNSIGNED_INTEGER MarkChou 20190313
            public string ECID;
            /// <summary>
            /// The ecv
            /// </summary>
            //[SecsElement(Index = 2, Type = SecsElement.SecsElementType.TYPE_ASCII, Length = 10)]
            [SecsElement(Index = 2, Type = SecsElement.SecsElementType.TYPE_2_BYTE_UNSIGNED_INTEGER, Length = 10)]//變更Type為TYPE_2_BYTE_UNSIGNED_INTEGER MarkChou 20190313
            public string ECV;
        }
    }
}
