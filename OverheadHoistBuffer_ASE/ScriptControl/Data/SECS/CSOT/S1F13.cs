...
namespace com.mirle.ibg3k0.sc.Data.SECS.CSOT
{
    ...
    public class S1F13 : SXFY
    {
        ...
        [SecsElement(Index = 1, Type = SecsElement.SecsElementType.TYPE_ASCII, Length = 6)]//長度改為6 Markchou 20190313
        public string MDLN;
        /// <summary>
        /// Software revision code
        /// </summary>
        //[SecsElement(Index = 2, Type = SecsElement.SecsElementType.TYPE_ASCII, Length = 20)]
        [SecsElement(Index = 2, Type = SecsElement.SecsElementType.TYPE_ASCII, Length = 6)]//長度改為6 Markchou 20190313
