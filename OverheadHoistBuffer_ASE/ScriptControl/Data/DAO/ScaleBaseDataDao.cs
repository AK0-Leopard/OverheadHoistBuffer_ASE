...
namespace com.mirle.ibg3k0.sc.Data.DAO
{
    ...
    public class ScaleBaseDataDao : DaoBase
    {
        /// <summary>
        /// The logger
        /// </summary>
        ...
        public void insert(DBConnection_EF conn, SCALE_BASE_DATA entity) 
        {
            try
            {
                conn.SCALE_BASE_DATA.Add(entity);
                conn.SaveChanges();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="conn">The connection.</param>
        /// <param name="alarm">The alarm.</param>
        public SCALE_BASE_DATA getReleaseData(DBConnection_EF conn)
        {
            try
            {
                var query = from entity in conn.SCALE_BASE_DATA
                            select entity;
